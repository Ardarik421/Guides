...
| Ид. номер                      | СНИЛС. Одинадцатитизначная комбинация цифр, разделенных дефисом. Должно быть заполнено | Пример: **XXX-EEE-YYY ZZ**                                   |
...
| Дата завершения оказания услуги          | Дата вида дд.мм.гггг. Должно быть заполнено. Не может быть больше даты загрузки файла | Дата вида дд.мм.гггг. Пример: **15.02.2022**                 |
...
| Факторы рисков | Код по МКБ10                                                 | Наименование вредных или опасных производственных факторов в соответствии с приказом Минздрава России от 28.01.2021 N 29н |
