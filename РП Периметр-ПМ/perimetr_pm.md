...
| Поле                    | Требование                                                   | Комментарий                                                  |
| ----------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| СНИЛС                   | Одиннадцатитизначная комбинация цифр, разделенных дефисом.   | Пример: **XXX-EEE-YYY ZZ**                                   |
...
| Поле                                          | Требование                                                   | Комментарий                                                  |
| --------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| UID                                           | Одиннадцатитизначная комбинация цифр, разделенных дефисом. Должно быть заполнено | СНИЛС. Пример: **XXX-EEE-YYY ZZ**                            |
...
| Ид. номер                      | СНИЛС. Одиннадцатитизначная комбинация цифр, разделенных дефисом. Должно быть заполнено | Пример: **XXX-EEE-YYY ZZ**                                   |
...
| UID                                      | Должно быть заполнено. Одиннадцатитизначная комбинация цифр, разделенных дефисом. | СНИЛС. Пример: **XXX-EEE-YYY ZZ**                            |
