...
В системе существует возможность настройки расписания для каждого медицинского работника. Расписание разбито на определенные периоды, каждый из которых может собственный уникальный график работы.

Для создания нового расписания, на вкладке **Медперсонал** кликнете по записи с данными медицинского работника:

![Переход в карточку сотрудника](img/nastr2.png)

Откроется окно **Расписание**. Укажите длительность приема медицинским работником (1). Далее, нажмите кнопку **Добавить период** (2). Будет сформирован особый блок, содержащий информацию по графику работы (3).

![Окно расписания](img/nastr3.png)

Задайте временной период, в течение которого будет актуален данный график работы медицинского работника. 

Для этого, укажите дни недели которые будут являться рабочими для данного сотрудника, путем установки соответствующих чекбоксов (1).  Выберите время начала и окончания рабочего дня (2), в случае необходимости укажите время на перерыв (3). 

Если в указанный временной период у медицинского работника планируется отпуск, то в блоке **Нерабочие дни** укажите периоды отсутствия медицинского работника (4):
...
Расписать что за протоколы и зачем нужны
