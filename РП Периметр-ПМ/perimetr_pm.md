...
| Документ                             | Шаблон                                                       |
| ------------------------------------ | ------------------------------------------------------------ |
| Структура подразделений площадки     | [Подразделения. Пример.csv](files\Подразделения. Пример.csv) |
| Сотрудники предприятия               | [Сотрудники.Пример.csv](files\Сотрудники.Пример.csv)         |
| Профессиональный медицинский осмотр  | [ПМО.Пример.csv](files\ПМО.Пример.csv)                       |
| Учет временной нетрудоспособности    | [ВУТ.Пример.csv](files\ВУТ.Пример.csv)                       |
| Добровольное медицинское страхование | [ДМС.Пример.csv](files\ДМС.Пример.csv)                       |
| Оценка условий труда                 | [СОУТ.Пример.csv](files\СОУТ.Пример.csv)                     |
...
| Поле                    | Требование                                                   | Комментарий                                                  |
| ----------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| UUID (СНИЛС)            | Одиннадцатитизначная комбинация цифр, разделенных дефисом.   | Пример: **XXX-EEE-YYY ZZ**                                   |
...
| id подразделения        | Должно быть заполнено                                        | Берется из кадровой учетной системы предприятия.             |
...
| Поле                     | Требование                                                   | Комментарий                                                  |
| ------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Employer_uuid            | Одинадцатитизначная комбинация цифр, разделенных дефисом. Должно быть заполнено | СНИЛС. Одинадцатитизначная комбинация цифр, разделенных дефисом. Пример: **XXX-EEE-YYY ZZ** |
